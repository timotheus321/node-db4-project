const recipes = [
    ...
    { reciple_name: 'Salmon en Papillote'}
]
...
const steps = [
   ...
   { step_text: 'Add pesto mixed with sauce', step_number: 3, recipe_id: 1 },
    //Lemon Chicken
      { step_text: 'Heat oven', step_number: 1, recipe_id: 2 },
      { step_text: 'Put chiecken and lemon in oven', step_number: 2, recipe_id: 2 },
